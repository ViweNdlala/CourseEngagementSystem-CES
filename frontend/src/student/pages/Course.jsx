...
/**
 * StudentCourseHome component
 * - Displays course info for the student.
 * - Shows active geofence session (if any) and allows student to join.
 * - Uses geolocation API to check if student is within geofence.
 */
function StudentCourseHome() {
  ...
  /**
   * Check student location to see if they are within the active geofence.
